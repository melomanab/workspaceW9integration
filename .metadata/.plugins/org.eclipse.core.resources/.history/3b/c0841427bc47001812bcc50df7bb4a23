...
public class ClientJerseyPost {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * // A. sur serveur local: OK WebResource webResource = client
			 * .resource("http://localhost:8080/demoJerseyJson/webapi/json/metallica/post");
			 * 
			 */
			// B. sur serveur distant: OK
			WebResource webResource = client.resource("http://192.168.1.55:8080/tpJson/rest/json/metallica/post");
